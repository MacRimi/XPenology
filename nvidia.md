...
### hay Hay una actualización para la versión 7.2 [aqui](https://github.com/MacRimi/XPenology/blob/main/nvidia.md#parcheamos-el-controlador-version-72-actualización-2)
##
### Preparación:
